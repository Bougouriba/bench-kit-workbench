...
class ElectronJupyterLab extends JupyterLab {
  ...
  constructor(options: ElectronJupyterLab.IOptions) {
    ...
    //log.info("Creating _electronInfo",this._electronInfo)
    //log.info("Creating _electronInfo - keys defaultInfo:",Object.keys(JupyterLab.defaultInfo))
    //log.info("Creating _electronInfo - keys options:",Object.keys(options))
