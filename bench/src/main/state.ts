...
import {
    JSONObject, ReadonlyJSONValue
} from '@phosphor/coreutils';
export type IStateItem = ReadonlyJSONValue
import {
    IStateDB
...
class ElectronStateDB implements IStateDB {
    ...
    constructor(options: ElectronStateDB.IOptions) {
        ...
        log.info("ElectronStateDB:namespace = ",this.namespace,"Datafile=",this._dataFile)
    }
    ...
    list(namespace: string): Promise<{ ids: string[]; values: IStateItem[] }> {
