...
export const RELATIVE_LIBRARY_BASE="rustlib/libindy/target"
export const RELEASE_LIBRARY      =RELATIVE_LIBRARY_BASE + "/release/libindy.dylib"
export const DEBUG_LIBRARY        =RELATIVE_LIBRARY_BASE + "/debug/libindy.dylib"
