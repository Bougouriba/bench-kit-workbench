...
class Application extends React.Component<Application.IProps, Application.IState> {
    ...
    constructor(props: Application.IProps) {
        ...
        //this._renderSettingsScreen = this._renderSettingsScreen.bind(this);
    ...
    private _serverReady(data: IServerFactory.IServerStarted): void {
        log.info("app.tsc reports _serverReady - called w/ data:",data)
        if (data.err) {
            log.error(data.err);
        ...
        this._lab.restored.then( () => {
          console.log("app.tsx sending main process the 'lab-ready' signal")
    ...
    private _setupLab() {
        ...
        console.log("app.tsx using extensions",extensions)
